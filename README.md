...
## Project Structure
    ...
    ├── kare_multiple_bouti_34964  # Django project configurations
...
1. Clone this repo and `cd kare_multiple_bouti_34964`
...
2. Clone this repo and `cd kare_multiple_bouti_34964`
